  ...
  Meteor.methods({
    downloadMidi: function(url) {
      ...
      try {
        ...
        Translator.midiToNotes(rawData);
        return Meteor.call('createTranslatedSong', Translator.notes,
          Translator.notesByTrack, Translator.songInfo, Translator.channels, rawData);
      } catch(e) {
        console.log(e)
